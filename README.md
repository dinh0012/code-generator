...
## Installation
Require the package using composer `composer require dinh0012/code-generator --dev`. Code generator is usually intended to be installed only in dev environment. Installation in prod environment is not recommended.

## Usage example
```php
<?php

use Dinh0012\CodeGenerator\Model\ArgumentModel;
use Dinh0012\CodeGenerator\Model\ClassModel;
use Dinh0012\CodeGenerator\Model\ConstantModel;
...
use Dinh0012\CodeGenerator\Model\UseTraitModel;
use Dinh0012\CodeGenerator\Model\UseClassModel;
use Dinh0012\CodeGenerator\Model\VirtualMethodModel;
